...
export const HeroSection: React.FC = () => {
  return (
    <section
      id="hero-section"
      className="relative h-screen w-full flex flex-col justify-between overflow-hidden bg-[#050507]"
    ...
    >
      ...
      <div className="absolute left-1/2 -translate-x-1/2 z-10 pointer-events-none sm:pointer-events-auto top-1/2 -translate-y-1/2 sm:top-auto sm:translate-y-0 sm:bottom-0 w-[240px] xs:w-[280px] sm:w-[360px] md:w-[440px] lg:w-[520px]">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(0,92,255,0.2)_0%,rgba(255,184,0,0.06)_50%,transparent_100%)] blur-[40px] pointer-events-none -z-10 w-[140%] h-[140%] -left-[20%] -top-[20%]" />
        ...
        <FadeIn delay={0.6} y={30} duration={0.9} className="flex justify-center select-none">
          ...
          >
            <img
              ...
              className="w-full h-auto object-contain drop-shadow-[0_0_60px_rgba(0,92,255,0.3)]"
            />
          </Magnet>
        </FadeIn>
      </div>
